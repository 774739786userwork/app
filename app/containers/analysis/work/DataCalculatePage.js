...
import YearCalculatePage from './datacalculate/YearCalculatePage';
import MonthCalculatePage from './datacalculate/MonthCalculatePage';
/**
 * 数据预测 */
class DataCalculatePage extends React.Component {
    ...
    render() {
        return (<View style={{ flex: 1, backgroundColor: '#f2f2f2' }}>
            <ScrollableTabView locked={true} initialPage={0} renderTabBar={this.renderTabBar} >
                <YearCalculatePage key={'0'} activeTab ={0} {...this.props} tabLabel={'year'}/>
                <MonthCalculatePage key={'1'}  activeTab ={1} {...this.props} tabLabel={'month'}/>
              </ScrollableTabView>
        </View>);
    }
}
export default DataCalculatePage;
