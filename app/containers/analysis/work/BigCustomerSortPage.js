...
import BigCustomerSortYearyPage from './BigCustomerSortYearyPage';
import BigCustomerSortMonthPage from './BigCustomerSortMonthPage';
/**
 * 产品大客户排名 详情 */
    ...
    render() {
        return (<View style={{ flex: 1, backgroundColor: '#f2f2f2' }}>
            <ScrollableTabView locked={true} initialPage={0} renderTabBar={this.renderTabBar} >
                <BigCustomerSortYearyPage key={'0'} activeTab ={0} {...this.props} tabLabel={'year'}/>
                <BigCustomerSortMonthPage key={'1'}  activeTab ={1} {...this.props} tabLabel={'month'}/>
              </ScrollableTabView>
        </View>);
    }
}
