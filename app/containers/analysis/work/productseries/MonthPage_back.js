    ...
    render() {
        return <View style={{ flex: 1, backgroundColor: '#f9f9f9' }}>
            <View style={{
                ...
                <View style={{ flex: 1 }} />
                <TouchableOpacity style={{marginRight:20, justifyContent: 'center', alignItems: 'center' }} onPress={() => { this.setState({ WeekModelShow: true }) }}>
                    <View style={{ justifyContent: 'center', alignItems: 'center' }}><Text style={{ color: '#0081d4', fontSize: 16 }}>{'筛选'}</Text></View>
                </TouchableOpacity>
            </View>
            ...
            <WeekModel modalVisible={this.state.WeekModelShow} onCancelPress={() => {
                this.setState({
                    WeekModelShow: false,
                })
            }}
