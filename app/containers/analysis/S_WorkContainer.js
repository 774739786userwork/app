...
const HomeItem = [
    ...
    { name: '分段客户', open: true, typeName: 'SumPartCustomer', image: require('../../imgs/work/s_fengduankehu.png') },
    ...
    { name: '数据预测', open: false, typeName: 'DataCalculatePage', image: require('../../imgs/work/s_shujuyuce.png') },
];
